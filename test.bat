...
.\release\dsfwtool.exe -c .temp\flashme\flashmev8a_noauto_tv\repack.bin -h .temp\flashme\flashmev8a_noauto_tv\unpack\header.bin -fh .temp\flashme\flashmev8a_noauto_tv\unpack\header_flashme.bin -p1 -comp -encrypt .temp\flashme\flashmev8a_noauto_tv\unpack\arm9_boot_code.bin -p2 -comp -encrypt .temp\flashme\flashmev8a_noauto_tv\unpack\arm7_boot_code.bin -p3 -comp .temp\flashme\flashmev8a_noauto_tv\unpack\arm9_gui_code.bin -p4 -comp .temp\flashme\flashmev8a_noauto_tv\unpack\arm7_wifi_code.bin -p5 -comp .temp\flashme\flashmev8a_noauto_tv\unpack\data_gfx.bin -fp1 -comp .temp\flashme\flashmev8a_noauto_tv\unpack\arm9_boot_code_flashme.bin -fp2 -comp .temp\flashme\flashmev8a_noauto_tv\unpack\arm7_boot_code_flashme.bin || exit /b 1
...
.\release\dsfwtool.exe -c .temp\flashme\flashmev8a_st\repack.bin -h .temp\flashme\flashmev8a_st\unpack\header.bin -fh .temp\flashme\flashmev8a_st\unpack\header_flashme.bin -p1 -comp -encrypt .temp\flashme\flashmev8a_st\unpack\arm9_boot_code.bin -p2 -comp -encrypt .temp\flashme\flashmev8a_st\unpack\arm7_boot_code.bin -p3 -comp .temp\flashme\flashmev8a_st\unpack\arm9_gui_code.bin -p4 -comp .temp\flashme\flashmev8a_st\unpack\arm7_wifi_code.bin -p5 -comp .temp\flashme\flashmev8a_st\unpack\data_gfx.bin -fp1 -comp .temp\flashme\flashmev8a_st\unpack\arm9_boot_code_flashme.bin -fp2 -comp .temp\flashme\flashmev8a_st\unpack\arm7_boot_code_flashme.bin || exit /b 1
...
.\release\dsfwtool.exe -c .temp\flashme\iquev2_flashme\repack.bin -h .temp\flashme\iquev2_flashme\unpack\header.bin -fh .temp\flashme\iquev2_flashme\unpack\header_flashme.bin -p1 -comp -encrypt .temp\flashme\iquev2_flashme\unpack\arm9_boot_code.bin -p2 -comp -encrypt .temp\flashme\iquev2_flashme\unpack\arm7_boot_code.bin -p3 -comp .temp\flashme\iquev2_flashme\unpack\arm9_gui_code.bin -p4 -comp .temp\flashme\iquev2_flashme\unpack\arm7_wifi_code.bin -p5 -comp .temp\flashme\iquev2_flashme\unpack\data_gfx.bin -fp1 -comp .temp\flashme\iquev2_flashme\unpack\arm9_boot_code_flashme.bin -fp2 -comp .temp\flashme\iquev2_flashme\unpack\arm7_boot_code_flashme.bin || exit /b 1
